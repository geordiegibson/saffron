        ...
        <div className="flex flex-col h-screen items-center">
            ...
            <div className="flex flex-col flex-grow w-[75vw] lg:w-[50vw]">
                ...
                <input 
                    ...
                    className="fixed bottom-1 w-[75vw] lg:w-[50vw] rounded-lg py-3 mb-24 text-sm bg-neutral-900 border-none placeholder:text-slate-400 focus:outline-none focus:ring-0 disabled:cursor-not-allowed disabled:opacity-50 text-white placeholder:text-slate-600"
