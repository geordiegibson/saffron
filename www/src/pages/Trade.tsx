        ...
        <div className="flex flex-col h-screen w-screen items-center">
            ...
            <div className="flex flex-col flex-grow bottom-animation w-[75vw] lg:w-[50vw]">
                ...
                <div className="flex-grow flex flex-col items-center justify-center mb-32">
                    <p className="text-gray-400 text-3xl mb-2"><i className="bi bi-bank"></i></p>
                    <p className="text-white geist">No Contracts</p>
                    <p className="text-gray-400">Get started by creating a new contract.</p>
                    <CreateContractModel 
