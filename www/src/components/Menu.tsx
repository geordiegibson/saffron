...
const Menu = (props: any) => {
    ...
    return (
        <div className="flex flex-col w-screen items-center justify-center">
            ...
            <nav className="fixed bottom-4 z-30 mx-auto flex w-max flex-row items-center justify-center gap-1 overflow-visible rounded-full bg-white p-1 shadow-lg ring-1 ring-zinc-300/50 backdrop-blur-sm dark:bg-zinc-900 dark:ring-zinc-700/50">
                                
                <Link to="/" className="group relative flex select-none items-center rounded-full bg-white p-3 outline-none transition-all duration-400 hover:bg-slate-200 data-selected:bg-black dark:bg-zinc-900 dark:hover:bg-slate-800 dark:data-selected:bg-white">
                ...
                <div className="mx-1 h-4 w-[1px] bg-black/10 bg-white/20 md:mx-2"></div>
