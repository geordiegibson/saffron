    ...
    return (
        <div className="flex flex-col w-screen items-center justify-center">
            ...
            <nav className="fixed bottom-4 z-30 mx-auto flex w-max flex-row items-center justify-center gap-1 overflow-visible rounded-full p-1 shadow-lg ring-1 ring-zinc-300/50 backdrop-blur-sm bg-zinc-900 ring-zinc-700/50">
                ...
                <Link to="/" className="group relative flex select-none items-center rounded-full p-3 outline-none transition-all duration-400 hover:bg-slate-200 bg-zinc-900 dark:hover:bg-slate-800">
