    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-neutral-900 p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
        ...
        {modalState === ModalState.LOADING &&
          <div className="flex justify-center items-center h-52" role="status">
        ...
        {modalState === ModalState.SUCCESS &&
          <div className='flex flex-col items-center mt-8 justify-center'>
            ...
            <span className="my-6 w-full gap-4 flex flex-col justify-between items-center px-6 py-3 text-green-200 bg-green-900/30 rounded-xl">
        ...
        {modalState === ModalState.FAIL &&
          ...
          <div className='flex flex-col items-center mt-8 justify-center'>
            ...
            <span className="my-6 w-full gap-4 flex flex-col justify-between items-center px-6 py-3 text-red-200 bg-red-900/30 rounded-xl">
